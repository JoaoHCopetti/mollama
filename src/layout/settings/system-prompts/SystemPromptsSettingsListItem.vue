...
<template>
  <li
    class="px-4 py-2 first:rounded-t-lg last:rounded-b-lg group bg-base-200 hover:bg-white/5 transition-all rounded-0 w-full cursor-pointer active:bg-white/10 [&:active:has(button:active)]:bg-white/5"
    :class="{
